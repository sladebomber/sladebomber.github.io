...
////////////////////////////////////
  ...
  var SentimentJSON = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/opening_comments.json")
...
////////////////////////////////////
  ...
  if (CriteriaVar1 == 1) {
  var data1 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/structure_comments.json")
  }

  if (CriteriaVar1 == 2){
  data1 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/demonstration_of_knowledge_comments.json")
  }

  if (CriteriaVar1 == 3){
  data1 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/engagement_with_theory_comments.json")
  }
  if (CriteriaVar1 == 4){
  data1 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/writing_comments.json")
  }


  if (CriteriaVar2 == 1) {
  var data2 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/structure_comments.json")
    }
  
  if (CriteriaVar2 == 2){
  data2 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/demonstration_of_knowledge_comments.json")
  }

  if (CriteriaVar2 == 3){
  data2 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/engagement_with_theory_comments.json")
  }
  if (CriteriaVar2 == 4){
  data2 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/writing_comments.json")
  }

  if (CriteriaVar3 == 1) {
  var data3 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/structure_comments.json")
  }

  if (CriteriaVar3 == 2){
  data3 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/demonstration_of_knowledge_comments.json")
  }

  if (CriteriaVar3 == 3){
  data3 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/engagement_with_theory_comments.json")
  }
  if (CriteriaVar3 == 4){
  data3 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/writing_comments.json")
  }

  
  if (CriteriaVar4 == 1) {
  var data4 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/structure_comments.json")
    }
  
  if (CriteriaVar4 == 2){
  data4 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/demonstration_of_knowledge_comments.json")
  }

  if (CriteriaVar4 == 3){
  data4 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/engagement_with_theory_comments.json")
  }
  if (CriteriaVar4 == 4){
  data4 = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/writing_comments.json")
  }
...
if (SliderVar4 == 2){
  ...
  var refData = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/referencing.json")
  ...
  var finalCommentData = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/last_comments.json")
  ...
  var latePenaltyData = fetch("http://60.241.194.95:8081/Diogenes JSON Comment Banks/latesubmission.json") 
